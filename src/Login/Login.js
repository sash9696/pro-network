		...
		<div className="login_container">
			...
			<div className="login_container_right">
				<div className="form_container">
					...
					<h3 onClick={guest} className="guest_option">
						{" "}
						Guest Login
					</h3>
					<p>
						Not a member?
						<span onClick={register} className="register_option">
							{" "}
							Register now.
						</span>
					</p>
