  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar__bottom">
        ...
        {recentItem("programming", "https://en.wikipedia.org/wiki/Computer_programming")}
        {recentItem("softwareengineering", "https://www.javatpoint.com/software-engineering-tutorial")}
        {recentItem("design", "https://en.wikipedia.org/wiki/Web_design")}
        {recentItem("developer", "https://en.wikipedia.org/wiki/Web_developer")}
      </div>
    </div>
  );
};
