	...
	(
		...
		return (
			<div ref={ref} className="posts_container">
				...
				<div
					className={
						usersPost ? "posts_options" : "posts_options_not_user"
					}>
					<InputItems
						Icon={
							hasUserLikedThePost
				...
				<Modal
					...
					<div className="edit_post_modal_heading">
						<h2>Edit Post</h2>
						<button
							className="edit_post_modal_heading_close"
							onClick={closeModal}>
							&#10539;
						</button>
					</div>
					<input
						className="edit_post_modal_input"
						defaultValue={message}
						onChange={editPostHandler}
					/>
					<div
						className="edit_post_modal_update_btn"
						onClick={() => {
							updateThePost();
							closeModal();
						}}>
